...
public class UniversidadMode{
    ...
    public static ArrayList<Rectores> getRectores(){
        ...
        try {
            ...
            while( cursorUniversidad.next() ){
                ...
                _miRector.setNOMBRECAMPUS(cursorUniversidad.getString("UNIVERSIDAD"));
                _miRector.setNOMBREUNIVERSIDAD(cursorUniversidad.getString("RECTOR"));
    ...
    public static boolean editarRectores(Rectores rectoresAEditar){
        try{
            String sqlStr = "UPDATE  universidad set SIGLA = '%s', UNIVERSIDAD = '%s', RECTOR = '%s' where ID=%f;";
